...
<section id="admin-content" class="p-3">
	<%
		String rolePath = request.getContextPath() + "/role/edit";
	%>
	<h3 class="mb-4 text-center">Thay đổi quyền</h3>
	<form method="post" action="<%=rolePath%>">
		<div class="row">
			<div class="col-md-6 m-auto">
				<div class="form-group">
					<label>Id</label> <input type="number" name="id"
						class="form-control" placeholder="id" value="${role.id }"/>
				</div>
				<div class="form-group">
					<label>Tên quyền</label> <input type="text" name="name"
						class="form-control" placeholder="name" value="${role.name }"/>
				</div>
				<div class="form-group">
